...
import MachineProfile from './components/MachineProfile/index';
  ...
  const navAndRoutes = (
    ...
    {/* Navigation */}  
      <Routes>
        ...
        <Route path="/Service/:id" element={<MachineProfile />} />
  ...
  return (
    <ApolloProvider client={client}>
      ...
      <div className="flex-grow flex flex-col lg:flex-row h-full" >
          {/* Branded Sidebar */}
      {isLoggedIn ? 
          <div className="w-full lg:w-20 flex-shrink-0 flex flex-col">
          <Nav/>
          </div>
           : <>
