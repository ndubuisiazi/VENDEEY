...
mutation AddMachineSelection($id: ID!, $machineselection: String!, $machinename: String) {
  addMachineSelection(_id: $id, machineselection: $machineselection, machinename: $machinename) {
    orders {
      machinename
    }
  }
...
mutation Mutation($id: ID!, $productId: Int!, $productName: String!, $category: String!, $img: String) {
  addItems(_id: $id, productId: $productId, productName: $productName, category: $category, img: $img) {
    orders {
      items {
        _id
        category
...
`
export const DELETITEM = gql`
mutation Mutation($id: ID!, $productId: Int!) {
  removeItem(_id: $id, productId: $productId) {
    orders {
      items {
        productId
        productName
