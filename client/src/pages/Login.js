    ...
    <div className="w-full h-full flex flex-col items-center justify-center ">
      ...
      <div className="w-full lg:w-1/3 h-3/4 p-20 rounded-lg bg-white border border-gray-600 rounded shadow-md">
        ...
        <form onSubmit={handleFormSubmit} id="login">
          ...
          />
          <button className="lg:text-sm text-4xl h-32 lg:h-10 btn btn-block btn-primary w-full p-2  text-white font-semibold rounded mb-20 lg:mb-2 rounded-lg"
          type="submit" style={{ background: "#17252A" }}>
            LOG IN
          </button>
        </form>
