...
const HowItWorks = () => {
  return (
    <div className='w-full h-full flex flex-col col-span-5 items-center' style={{ background: "#F6F6F2"}}>
      ...
      <div className='flex flex-row lg:flex-col justify-start m-10 lg:m-2 h-full'>
          ...
          <p className='flex justify-center text-4xl'>
            <ImPencil2 style={{ color: "#388087" , background: "#F6F6F2"}}/>
          </p>
        </div>
        <div className='flex flex-row lg:flex-col justify-start m-10 lg:m-2 h-full'>
        <p className='text-left lg:text-2xl text-6xl mr-4'>
          ...
          <p className='flex justify-center text-4xl '>
            <GiVendingMachine style={{ color: "#388087" , background: "#F6F6F2"}}/>
          </p>
        </div>
        <div className='flex flex-row lg:flex-col justify-start m-10 lg:m-2 h-full'>
          <p className='text-left lg:text-2xl text-6xl mr-4'>
          ...
          <p className='flex justify-center text-4xl'>
            <MdOutlineDoneOutline style={{ color: "#388087" , background: "#F6F6F2"}} className='text-red'/>
          </p>
        </div>
      </div>
